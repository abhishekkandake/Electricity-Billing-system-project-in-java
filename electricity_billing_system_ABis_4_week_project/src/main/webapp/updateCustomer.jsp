...
<style>
	...
	.d7{
		...
		background-image:url("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSgT2PdyJ5PNDrD7Q3exkRl-yXY8ouIn-8-DQ&usqp=CAU");
		background-size: cover;
		background-repeat: no-repeat;
	...
	<div class = "d2">
		<div class = "d3">
			...
			<div class = "d6">
				...
				<br><br>
					<input class = "ip" type = "number" name = "mitterno" placeholder = "Enter Mitterno">
					<input type = "text" name = "name" placeholder = "Enter name">
					<input type = "text" name = "email" placeholder = "Enter email"><br><br>
					<input type = "text" name = "password" placeholder = "Enter Password">
					<input type = "text" name = "billtype" placeholder = "Enter Bill Type">
					<input type = "text" name = "city"  placeholder = "Enter city"><br><br>
					<input type = "text" name = "state" placeholder = "Enter State">
					<input type = "text" name = "mitterloc" placeholder = "Enter mitterloc">
					<input type = "text" name = "mittertype" placeholder = "Enter Mittertype"><br><br>
					<input type = "number" name = "phasecode" placeholder = "Enter PhaseCode">
					<input type = "tel" name = "phone" placeholder = "Enter Phone number">
					<button class = "button">Update</button><button class= "button"><a href = "customerhome.html">Back</a></button>
				</form>
			</div>
			<div class = "d7">
