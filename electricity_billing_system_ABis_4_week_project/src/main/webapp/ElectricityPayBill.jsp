...
<body>
	<div class = "d1">
		<ul>
			...
			<li class = "li" style = "margin-left:70.5px; "><form action = "logoutcustomer" method = "post"><button class = "bttt1" style = "margin-top:0px;">Logout</button></form></li>
		</ul>
	</div>
		<div class = "d2">
			<div class = "d3">
					...
					<div class = "d9">
						<div class = "d10">
							<form action = "pay" method = "post">
								...
								<input  type = "number" name = "mitterno" ><br>
								
								<label>Month :</label><br>
								<input class = "ii1" type = "text" name = "month" ><br>
						
								<button class = "btt1">Search</button><button class = "btt1"><a href = "customerhome.html">Back</a></button>
							</form>
						</div>
					</div>
				</div>
